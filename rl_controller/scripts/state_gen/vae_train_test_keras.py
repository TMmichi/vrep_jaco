...
encoder = state_gen_util.CNN_Encoder()
mean, var = encoder(data)

decoder = state_gen_util.CNN_Decoder()
x_hat = decoder(mean)

quit()

#x_hat, z, loss, neg_marginal_likelihood, KL_divergence = state_gen_util.Autoencoder(x, dim_z=64 ,trainable=True)
