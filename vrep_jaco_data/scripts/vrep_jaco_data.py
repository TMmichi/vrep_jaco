...
class Vrep_jaco_data:
    def __init__(self):
        ...
        self.rgb0 = True # at first
        self.rgb1 = True # at first
        self.rgb2 = True # at first
        self.rgb3 = True # at first
        ...
        self.net = yolo.load_net(b"/home/kimtaehan/Desktop/ws/vrep_jaco/src/vrep_jaco_data/scripts/darknet/cfg/yolov3-tiny.cfg", b"/home/kimtaehan/Desktop/ws/vrep_jaco/src/vrep_jaco_data/scripts/darknet/yolov3-tiny.weights", 0)
        self.meta = yolo.load_meta(b"/home/kimtaehan/Desktop/ws/vrep_jaco/src/vrep_jaco_data/scripts/darknet/cfg/coco.data")

        self.jointstate_sub = rospy.Subscriber("/j2n6s300/joint_states",JointState,self.jointstate_CB, queue_size=1)
    ...
    def rgb_CB0(self,msg):
        ...
        plt.close()
        # print("gogo")
        r = yolo.detect(self.net, self.meta, b"/home/kimtaehan/Desktop/ws/vrep_jaco/src/vrep_jaco_data/image/figure_rgb0.jpg")
        if(len(r)==0):
            data_center = [[-1,-1]]
        else:
            print(r[0][0])
    ...
    def rgb_CB1(self,msg):
        ...
        plt.close()
        r = yolo.detect(self.net, self.meta, b"/home/kimtaehan/Desktop/ws/vrep_jaco/src/vrep_jaco_data/image/figure_rgb1.jpg")
        if(len(r)==0):
            data_center = [[-1,-1]]
        else:
            data_center = []
    ...
    def rgb_CB2(self,msg):
        ...
        plt.close()
        r = yolo.detect(self.net, self.meta, b"/home/kimtaehan/Desktop/ws/vrep_jaco/src/vrep_jaco_data/image/figure_rgb2.jpg")
        if(len(r)==0):
            data_center = [[-1,-1]]
        else:
            data_center = []
    ...
    def rgb_CB3(self,msg):
        ...
        plt.close()
        r = yolo.detect(self.net, self.meta, b"/home/kimtaehan/Desktop/ws/vrep_jaco/src/vrep_jaco_data/image/figure_rgb3.jpg")
        if(len(r)==0):
            data_center = [[-1,-1]]
        else:
            data_center = []
    ...
    def data_time_check(self, interval):
        ...
        for i in range(10):
            ...
            if minima>self.data_buff_temp[i][1] and self.data_buff_temp[i][1]!=0:
    ...
    def data_record(self):
        plt.imsave(self.rospack.get_path('vrep_jaco_data')+'/image/figure0_'+str(self.num)+'.jpg',self.data_buff_temp[0][0],cmap='gray')
        plt.imsave(self.rospack.get_path('vrep_jaco_data')+'/image/figure1_'+str(self.num)+'.jpg',self.data_buff_temp[1][0],cmap='gray')
        plt.imsave(self.rospack.get_path('vrep_jaco_data')+'/image/figure2_'+str(self.num)+'.jpg',self.data_buff_temp[2][0],cmap='gray')
        plt.imsave(self.rospack.get_path('vrep_jaco_data')+'/image/figure3_'+str(self.num)+'.jpg',self.data_buff_temp[3][0],cmap='gray')
        self.num+=1
        plt.close()
