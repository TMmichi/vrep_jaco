...
If have you install Coppelia(v4.0.0) instead of V-rep(v3.6.n), you need to move `libsimExtROSInterface.so` file from folder: `compiledRosPlugins` to the source folder.
